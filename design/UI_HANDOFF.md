...
> 文档状态：v0.1 / UI 设计前置交付稿  
> 更新时间：2026-07-28  
> 适用对象：UI/UX 设计师、Flutter 前端开发、产品走查  
> 关联用户故事：US-001 ~ US-010，重点为 US-004、US-005、US-006、US-007、US-008、US-009、US-010  
...
把小红书、抖音等平台上的图文 / 视频菜谱，转换成可编辑、可保存、可执行的个人结构化菜谱库。
...
| 导航 | 名称 | 主要目的 | MVP 优先级 |
|---|---|---|---|
| Tab 1 | 首页 | 快速导入、最近菜谱、常用分类、继续烹饪 | P0 |
| Tab 2 | 菜谱库 | 全部菜谱、分类、搜索、收藏、回收站入口 | P0 |
| Tab 3 | 添加 | 粘贴链接、手动创建、导入图片 / 视频 / 文本 | P0 |
| Tab 4 | 我的 | 登录、游客状态、LLM 设置、OCR 设置、隐私与数据 | P0 |

> 说明：购物清单、周菜单、营养统计可以作为 P1/P2 功能，不建议占用 MVP 底部导航。
...
5. 最后补 `DESIGN-003` 设置页，因为设置页依赖后端能力文案。
6. 每个设计版本完成后，用 `design/reviews/DESIGN_REVIEW_CHECKLIST.md` 走查。
7. 走查通过后再进入高保真或 HTML 原型。
