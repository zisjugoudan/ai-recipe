...
| SPK-002 | P0 | DOING | PaddleOCR 本地引擎与插件验证 | 模型包管理、MethodChannel、Android ONNX Session 健康检查和 237 项测试已通过；真实识别、真机指标与 iOS 仍待完成 | `research/spikes/SPK-002-local-ocr.md` |
