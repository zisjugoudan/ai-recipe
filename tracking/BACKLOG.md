...
| SPK-002 | P0 | DOING | PaddleOCR 本地引擎与插件验证 | 模型包管理、同一服务实例内串行队列、显式取消、Android 空间预检、旧版本回收、MethodChannel、Android ONNX Session 健康检查和 259 项测试已通过；真实识别、真机指标、iOS 与跨进程互斥仍待完成 | `research/spikes/SPK-002-local-ocr.md` |
